        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">Choose a date to view trading records</p>
            </div>
            <button
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <button
              ...
              className="p-3 hover:bg-gray-100 rounded-xl transition flex items-center gap-2 font-semibold text-gray-700"
            >
            ...
            <>
              ...
              <div className="grid grid-cols-7 gap-3">
                {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map(day => (
                  <div key={day} className="text-center text-sm font-bold text-gray-600 py-3 uppercase tracking-wide">
                    {day}
                  </div>
                ))}
                ...
                {daysInMonth.map(date => {
                  ...
                  return (
                    <button
                      ...
                      className={`
                        aspect-square p-3 rounded-xl transition-all relative font-semibold text-lg
                        ...
                        ${isAllowed && !isFuture && !hasData ? 'hover:bg-indigo-50 cursor-pointer border-2 border-gray-200' : ''}
                    ...
                    >
                      ...
                      {isToday && !hasData && (
                        <div className="absolute bottom-1 left-1/2 transform -translate-x-1/2">
                          <div className="text-xs text-indigo-600 font-bold">Today</div>
                        </div>
                      )}
                    </button>
                  );
              ...
              <div className="mt-8 flex flex-wrap gap-6 text-sm justify-center">
                <div className="flex items-center gap-2">
                  <div className="w-10 h-10 bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-lg shadow"></div>
                  <span className="font-medium">Has Data</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-10 h-10 bg-gray-50 border-2 border-gray-200 rounded-lg"></div>
                  <span className="font-medium">No Data</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-10 h-10 bg-gray-50 opacity-20 rounded-lg"></div>
                  <span className="font-medium">Future/Locked</span>
                </div>
              </div>
